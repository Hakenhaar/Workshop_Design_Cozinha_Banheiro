...
"""
╔══════════════════════════════════════════════════════╗
║   DOCOL INSIGHTS — Workshop Ambientes Residenciais   ║
║   Cozinha & Banheiro · Coleta de Insights            ║
╚══════════════════════════════════════════════════════╝
...
BACKUP_FILE = "docol_workshop_backup.json"
        ...
        if path == "/api/data":
            ...
            with DATA_LOCK:
                ...
                self.send_json({
                    ...
                    "by_environment": {k: len(v) for k, v in DATA.get("notes", {}).items()}
                })
...
if __name__ == "__main__":
    ...
    print()
    print("  ╔══════════════════════════════════════════════╗")
    print("  ║     DOCOL INSIGHTS — Workshop Ambientes      ║")
    print("  ║     Cozinha & Banheiro                       ║")
    print("  ╠══════════════════════════════════════════════╣")
    print(f"  ║                                              ║")
